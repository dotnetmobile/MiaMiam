...
<html>
	<head>
		...
		<title><g:message code="photoStep.create.label" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#create-photoStep" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-photoStep" class="content scaffold-create" role="main">
			<h1><g:message code="photoStep.create.label" args="[entityName]" /></h1>
