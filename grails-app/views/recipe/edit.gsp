...
<html>
	<head>
		...
		<title><g:message code="recipe.edit.label" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#edit-recipe" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-recipe" class="content scaffold-edit" role="main">
			<h1><g:message code="recipe.edit.label" args="[entityName]" /></h1>
