...
class PdfGenerator {
	...
	private createIntroduction() {
		def preface = new Chunk("Préface", font20)
		//Paragraph paragraph1 = new Paragraph(recipe.name, font18)
		...
		def aPropos = new Chunk("""Il y a des choses qu'on aiment partager entre amies, familles et connaissance, ce sont nos recettes préférées. 
		C'est la raison pour laquelle j'ai voulu créer mon site pour faire plaisir et se faire plaisir!
		Ma cuisine se veut facile, goûteuse, respectueuse des saisons et hétéroclite.
